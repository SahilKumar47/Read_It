...
export class createVotesTable1611673962327 implements MigrationInterface {
    name = 'createVotesTable1611673962327'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `votes` (`id` int NOT NULL AUTO_INCREMENT, `createAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `value` int NOT NULL, `username` varchar(255) NOT NULL, `postId` int NULL, `commentId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
