...
export class createVotesTable1612092967255 implements MigrationInterface {
    name = 'createVotesTable1612092967255'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `email` varchar(255) NOT NULL, `username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, INDEX `IDX_97672ac88f789774dd47f7c8be` (`email`), INDEX `IDX_fe0bb3f6520ee0469504521e71` (`username`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `subs` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `title` varchar(255) NOT NULL, `description` text NULL, `imageUrn` varchar(255) NULL, `bannerUrn` varchar(255) NULL, `username` varchar(255) NULL, INDEX `IDX_2ae46b179b70ab8179597adb8c` (`name`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
