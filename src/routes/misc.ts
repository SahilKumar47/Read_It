...
const topSubs = async (_: Request, res: Response) => {
  try {
     ...
     * LIMIT 5;
     * */
    const imageUrlExp = `CASE
    WHEN s.imageUrn IS NOT NULL THEN CONCAT('${process.env.APP_URL}/images/', s.imageUrn )
    ELSE "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y"
END`;
